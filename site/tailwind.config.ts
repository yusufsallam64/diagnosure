...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        'text': 'oklch(85.00% 0.016 67.61)',
        // 'text': {
        //   50: 'oklch(16.04% 0.007 78.07)',
        //   100: 'oklch(22.06% 0.011 73.33)',
        //   200: 'oklch(32.78% 0.020 67.03)',
        //   300: 'oklch(42.91% 0.028 69.04)',
        //   400: 'oklch(52.25% 0.036 66.91)',
        //   500: 'oklch(61.40% 0.043 68.14)',
        //   600: 'oklch(69.38% 0.033 67.23)',
        //   700: 'oklch(77.37% 0.025 69.52)',
        //   800: 'oklch(85.00% 0.016 67.61)',
        //   900: 'oklch(92.67% 0.008 73.74)',
